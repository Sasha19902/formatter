...
public class StateRepository {
    ...
    public StateRepository(Map<String, String> keySymbols) {
        ...
        for (Map.Entry<String, String> element : keySymbols.entrySet()) {
            lexerStateMap.put(new Pair<>(states.get(DEFAULT_STATE), element.getKey()), states.get(PREPARATION_STATE));
    ...
    public LexerState getState(LexerState prevState, String element) {
        return lexerStateMap.getOrDefault(new Pair<>(prevState, element), new LState(READING_STATE));
    }
